...
import { fetchUser, fileUpload, updateUser, birthdayImage, unnesImage as unnesImageService } from '@/services/User.services';
...
watch(() => props.visible, async (newVal) => {
  ...
  avatar.value = BASE_URL + 'avatar/' + user.value.avatar
